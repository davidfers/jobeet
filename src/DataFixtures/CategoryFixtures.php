...
class CategoryFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager) : void
    {
        ...
        $programmignCategory = new Category();
        $programmignCategory->setName('Programming');
        ...
        $manager->persist($programmignCategory);
        ...
        $this->addReference('category-programming', $programmignCategory);
